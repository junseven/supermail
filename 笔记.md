...
- [四、better-scroll](#四better-scroll)
  - [1. 设置高度](#1-设置高度)
    - [1.1 计算高度](#11-计算高度)
    - [1.2 定位](#12-定位)
...
- [五、tabControl](#五tabcontrol)
  - [1. 点击切换数据](#1-点击切换数据)
  - [2. 吸顶效果](#2-吸顶效果)
  - [4. 两个 tabControl 解决闪退](#4-两个-tabcontrol-解决闪退)
- [六、保留home组件离开时的状态和位置](#六保留home组件离开时的状态和位置)
- [七、home组件跳转至详情页](#七home组件跳转至详情页)
- [八、详情页detail](#八详情页detail)
  - [1. 轮播图](#1-轮播图)
  - [2. 网络请求数据杂乱](#2-网络请求数据杂乱)
  - [3. 展示数据](#3-展示数据)
- [九、mixin 混入](#九mixin-混入)
- [十、详情页中navbar与内容的联动](#十详情页中navbar与内容的联动)
  - [1. 点击navbar改变样式](#1-点击navbar改变样式)
  - [2. 点击 navbar 跳转至相应位置](#2-点击-navbar-跳转至相应位置)
  - [3. 滚动内容区域与标题联动](#3-滚动内容区域与标题联动)
    - [3.1 普通做法](#31-普通做法)
    - [3.2 hack做法](#32-hack做法)
- [十一、点击加入购物车](#十一点击加入购物车)
